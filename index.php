...
<body>
    <nav class="navbar navbar-expand-md fixed-top mynavbar">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.php">
                <img src="/pkl/asset/img/logos1.png" alt="">
            </a>
            ...
            <ul class="navbar-nav">
                ...
                <a class="nav-link" href="/pkl/admin.php" role="button" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <section id="landing" class="landing w-100 h-100 p-3 mx-auto text-center d-flex 
    justify-content-center align-items-center">
        <div class="content">
            <h1>Sistem Informasi Kepuasan Kegiatan B2SA</h1>
    ...
    <div class="main-content">
        <h1>Sistem Informasi Kepuasan Kegiatan B2SA</h1>
        <h2>Dinas Pertanian dan Ketahanan Pangan Provinsi Jawa Timur</h2>
    </div> -->
