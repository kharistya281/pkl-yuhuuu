...
<head>
    ...
    <title>Evaluasi Kegiatan Bidang Ketahanan Pangan</title>
    ...
    <div class="container-fluid">
        <nav class="navbar navbar-expand-md navbar-dark">
            <a class="navbar-brand heading-black" href="index.html">
                <img src="img/logo.png" alt="logo-dinas" height="70px"/>
            </a>
    ...
    <div class="container">
        <div class="row vh-md-100">
            <div class="col-md-8 col-sm-10 col-12 mx-auto my-auto text-center">
                <h1 class="heading-black text-capitalize">Sistem Informasi Kepuasan dan Evaluasi Kegiatan</h1>
                <h3 class="heading-black text-capitalize">Dinas Pertanian dan Ketahanan Pangan Jawa Timur</h3>
                <a href="form-ver2.php">
...
<footer class="py-6">
    <div class="container">
        <div class="row">
            <div class="col text-muted text-center small-xl">
                &copy; 2024 Dinas Pertanian dan Ketahanan Pangan - All Rights Reserved
            </div>
        </div>
    </div>
</footer>
...
<!-- <footer>
    <p class="col-12 text-muted text-center small-xl">
        &copy; 2024 Dinas Pertanian dan Ketahanan Pangan - All Rights Reserved
    </p>
</footer> -->
